...
export function AdminOpsPanel({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <div className={embedded ? '' : 'space-y-4 border-t border-[#c7c8ce] bg-[#f4f5f8] px-4 py-5'}>
      {embedded ? (
        <WorkspacePanel className="space-y-4">
          <WorkspacePanelHeader
            eyebrow="Admin controls"
            title="Policy snapshots, changelog, and identity overrides"
            description="This keeps the admin surface inside the same internal app frame as the rest of the system."
          />
