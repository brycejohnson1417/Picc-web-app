...
const items = [
  ...
  { id: 'nav-vendor-days', label: 'Go to Vendor Days', href: '/vendor-days', section: 'Navigation' },
  { id: 'nav-territory', label: 'Go to Territory Map', href: '/territory', section: 'Navigation' },
