  ...
  try {
    ...
    return routeErrorResponse(error, {
      ...
      statusByMessage: {
        ...
        'Setup photo is required before checkout': 409,
        'End photo is required before checkout': 409,
        'Checkout notes are required before checkout': 409,
        'Traffic level is required before checkout': 409,
        'Budtender engagement score is required before checkout': 409,
